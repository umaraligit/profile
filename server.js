...
const userService  = require('./server/user/routes'),
  jwt = require('./server/utils/jwt'),
  errorHandler = require('./server/utils/errorHandler');
...
app.use(function (req, res, next) {
  ...
  const allowedOrigins = ['http://localhost:5000', 'http://localhost:3000', 'https:reqres.com'];
